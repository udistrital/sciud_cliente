          ...
          <div class="col">
            ...
            <div class="card-body">
              ...
              <DxDataGrid
                id="gridContainer"
                class="main"
                :data-source="VegParticipanteInt"
                :remote-operations="false"
                :allow-column-reordering="true"
                :row-alternation-enabled="true"
                :show-borders="false"
            ...
            <div class="card-body">
              ...
              <DxDataGrid
                id="gridContainer"
                class="main"
                :data-source="VegParticipanteExt"
                :remote-operations="false"
                :allow-column-reordering="true"
                :row-alternation-enabled="true"
                :show-borders="false"
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("VegParticipanteExt", { VegParticipanteExt: "items" }),
    ...mapGetters("VegParticipanteInt", { VegParticipanteInt: "items" }),
  ...
  methods: {
    ...mapActions("vegetal", ["all", "saveChange", "updateChange"]),
    ...mapActions("tipoVegetal", { getVegetals: "all" }),
    ...
    ...mapActions("VegParticipanteExt", {
      getVegParticipanteExt: "all",
      saveExtern: "saveChange",
      updateExtern: "updateChange",
    }),
    ...mapActions("VegParticipanteInt", {
      getVegParticipanteInt: "all",
    ...
    miClick(e) {
      ...
      var igGroup = root.group.id;
      obj.unidadId = igGroup;
      root.getVegParticipanteExt(obj);
      root.getVegParticipanteInt(obj);
