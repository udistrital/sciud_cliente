          ...
          <div class="col">
            ...
            <div class="card-body">
              ...
              <DxDataGrid
                id="gridContainer"
                class="main"
                :data-source="NotParticipanteInt"
                :remote-operations="false"
                :allow-column-reordering="true"
                :row-alternation-enabled="true"
                :show-borders="false"
            ...
            <div class="card-body">
              ...
              <DxDataGrid
                id="gridContainer"
                class="main"
                :data-source="NotParticipanteExt"
                :remote-operations="false"
                :allow-column-reordering="true"
                :row-alternation-enabled="true"
                :show-borders="false"
...
export default {
  ...
  computed: {
    ...mapGetters("nota", ["items"]),
    ...mapGetters("categoriaArt", ["items2"]),
    ...mapGetters("TipoParticipacion", { TipoParticipacion: "items" }),
    ...mapGetters("NotParticipanteExt", { NotParticipanteExt: "items" }),
    ...mapGetters("NotParticipanteInt", { NotParticipanteInt: "items" }),
  ...
  methods: {
    ...mapActions("nota", ["all", "saveChange", "updateChange"]),
    ...mapActions("categoriaArt", ["all2"]),
    ...mapActions("TipoParticipacion", { getTipoParticipacion: "all" }),
    ...mapActions("NotParticipanteExt", {
      getNotParticipanteExt: "all",
      saveExtern: "saveChange",
      updateExtern: "updateChange",
    }),
    ...mapActions("NotParticipanteInt", {
      getNotParticipanteInt: "all",
    ...
    miClick(e) {
      ...
      var igGroup = root.group.id;
      obj.unidadId = igGroup;
      root.getNotParticipanteExt(obj);
      root.getNotParticipanteInt(obj);
