  ...
  <div>
        ...
        <div class="card-body">
          ...
          >
            ...
            <DxColumn
              ...
              data-field="geo_country_id"
              caption="Pais de publicación"
              alignment="center"
              :hiding-priority="5"
            >
              <DxLookup
            ...
            <DxColumn
              data-field="geo_state_id"
              caption="Estado/Dep de publicación"
              alignment="center"
              :hiding-priority="4"
            >
              <DxLookup
            ...
            <DxColumn
              data-field="geo_city_id"
              caption="Ciudad de publicación"
              alignment="center"
              :hiding-priority="3"
              ><DxRequiredRule />
              <DxLookup
                :data-source="ciudades"
                value-expr="id"
                display-expr="name"
              />
            </DxColumn>
    ...
    >
      <DxScrollView width="100%" height="100%">
        <div class="row">
          <div class="col">
            <h3>Titulo del Capítulo</h3>
            <div class="card-body">
              <div>Participantes Internos</div>
              <DxDataGrid
                id="gridContainer"
                class="main"
                :data-source="CapParticipanteInt"
                :remote-operations="false"
                :allow-column-reordering="true"
                :row-alternation-enabled="true"
                :show-borders="false"
            ...
            <div class="card-body">
              ...
              <DxDataGrid
                id="gridContainer"
                class="main"
                :data-source="CapParticipanteExt"
                :remote-operations="false"
                :allow-column-reordering="true"
                :row-alternation-enabled="true"
                :show-borders="false"
...
export default {
  ...
  data() {
    return {
      ...
      setStateValue(rowData, value) {
        rowData.geo_state_id = null;
        this.defaultSetCellValue(rowData, value);
        console.log("mis valores", value);
      },
      popupVisible: false,
      editButtons: [
        "edit",
  ...
  computed: {
    ...mapGetters("capitulo", ["items"]),
    ...mapGetters("categoriaLib", ["items2"]),
    ...mapGetters("Pais", { paises: "items2" }),
    ...mapGetters("Estado", { estados: "items" }),
    ...mapGetters("Ciudad", { ciudades: "items" }),
    ...mapGetters("TipoParticipacion", { TipoParticipacion: "items" }),
    ...mapGetters("CapParticipanteExt", { CapParticipanteExt: "items" }),
    ...mapGetters("CapParticipanteInt", { CapParticipanteInt: "items" }),
  ...
  methods: {
    ...mapActions("capitulo", ["all", "saveChange", "updateChange"]),
    ...mapActions("categoriaLib", ["all2"]),
    ...
    ...mapActions("CapParticipanteExt", {
      getCapParticipanteExt: "all",
      saveExtern: "saveChange",
      updateExtern: "updateChange",
    }),
    ...mapActions("CapParticipanteInt", {
      getCapParticipanteInt: "all",
    ...
    miClick(e) {
      ...
      var igGroup = root.group.id;
      obj.unidadId = igGroup;
      root.getCapParticipanteExt(obj);
      root.getCapParticipanteInt(obj);
    ...
    // lista filtrada estado
    getFilteredCities(options) {
      this.getEstados(options.data);
      var esta = this.estados;

      console.log("mis estados", esta);
      ...
      if (typeof esta !== "undefined") {
        ...
        return {
          store: esta,
          filter: options.data
            ? ["geo_country_id", "=", options.data.geo_country_id]
            : null,
        };
      } else {
        this.getEstados(options.data);
        console.log("mis else", esta);
        this.estados;
        return esta;
      }
    },
    onEditorPreparing(e) {
      if (e.parentType === "dataRow" && e.dataField === "geo_state_id") {
        e.editorOptions.disabled =
          typeof e.row.data.geo_country_id !== "number";
      }
    },
  },
  mounted() {
