<template>
	<div class="col mt-3" id="panel-Raza" v-if="editMode">
			...
			<div class="col">
				<div class="card">
					<div class="card-header main">
						...
						<span class="font-weight-semibold">{{ editData ? "Editar" : "Crear" }} Poblacion Razas Pecuarias</span>
					</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Nombre: </label>
									<DxTextBox placeholder="Nombre" class="form-control" :value.sync="ip_livestock_breed.name">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<DxSelectBox
										...
										:value.sync="ip_livestock_breed.category_id"
										class="form-control"
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<DxDateBox
										...
										:value.sync="ip_livestock_breed.publication_date"
										id="publication_date"
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<DxSelectBox
										...
										:search-enabled="false"
										placeholder="Seleccione..."
										:value.sync="ip_livestock_breed.colciencias_call_id"
										class="form-control"
							...
							<div class="col-md-6"><Geo :lockElement="loaderElement" :syncObject="ip_livestock_breed" /></div>

							<div class="col-md-2">
								<div class="form-group">
									<label>Consecutivo: </label>
									<DxTextBox placeholder="Consecutivo" class="form-control" :value.sync="ip_livestock_breed.consecutive_number_ma">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label>Activo: </label>
									<DxSwitch :value.sync="ip_livestock_breed.Active" switched-on-text="SI" switched-off-text="NO" />
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<DxTextArea :height="100" :max-length="400" :value.sync="ip_livestock_breed.observation" placeholder="Observacion" class="form-control">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextArea>
			...
			<div class="col">
				<div class="p-0">
					<div class="page-header header-elements-md-inline">
						<div class="page-title d-flex">
							<h1>
								...
								<span class="font-weight-semibold">Poblacion Razas Pecuarias</span>
							</h1>
						</div>
						<div class="header-elements">
							<button type="button" @click.prevent="edit()" title="Nueva Raza.." class="btn btn-main btn-labeled btn-labeled-left " id="btn-add">
								<b><i class="icon-database-add"></i></b> Nueva Poblacion Razas Pecuarias
							</button>
						</div>
					</div>
					...
					>
						...
						<DxColumn data-field="name" width="20%" caption="Nombre Raza" data-type="string" alignment="center" :visible="true" :allow-grouping="false" />
						...
						<DxColumn data-field="consecutive_number_ma" caption="Concecutivo" data-type="string" alignment="center" :visible="true" :allow-grouping="false" />
						...
						<DxColumn data-field="geo_state_name" caption="Nombre" data-type="string" alignment="center" :visible="false" :allow-grouping="true" />
		...
		<div class="card mt-3" v-if="debug">
			<div class="card-body">
				{{ JSON.stringify(ip_livestock_breed, null, "\t") }}
			</div>
		</div>
	</div>
</template>
...
export default {
	...
	computed: {
		...
		dataSource: function() {
			...
			return DxStore({
				key: ["id"],
				endPoint: `research_units/${this.group.id}/ip_livestock_breeds`,
				// endPoint: `research_units/ip_livestock_breeds`,
	...
	methods: {
		...
		...mapActions("poblaciones", { ip_livestock_breedActive: "active" }),
		...
		active(data, state) {
			...
			this.$confirm(msg, function(si_no) {
				...
				if (si_no) {
					...
					root.loadShow();
					var dto = {
						url: `research_units/${root.group.id}/ip_livestock_breeds/${data.data.id}/active`,
						ip_livestock_breed: {
							ip_livestock_breed: {
								active: state,
								updated_by: 1,
					...
					console.log("dto", dto);
					root.ip_livestock_breedActive(dto);
				}
			});
		},
