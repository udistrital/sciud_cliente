<template>
	<div class="col mt-3" id="panel-industrial" v-if="editMode">
		<div class="row data slide">
			<div class="col">
				<div class="card">
					<div class="card-header main">
						<i class="icon-pencil3 mr-1 color-main-600"></i>
						<span class="font-weight-semibold">{{ editData ? "Editar" : "Crear" }} Diseño Industrial</span>
					</div>
					<div class="card-body mb-0 pb-0 pt-2">
						<div class="row">
							<div class="col-md-">
								<div class="form-group">
									<label>Núm registro diseño industrial: </label>
									<DxTextBox placeholder="Núm registro diseño industrial" class="form-control" :value.sync="diseño.num_reg_circuit">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-">
								<div class="form-group">
									...
									<DxTextBox placeholder="Título de registro" class="form-control" :value.sync="diseño.reg_title">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-">
								<div class="form-group">
									...
									<DxTextBox placeholder="Nombre del titular" class="form-control" :value.sync="diseño.name_holder">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-">
								<div class="form-group">
									...
									<DxDateBox
										...
										:value.sync="diseño.publication_date"
										id="publication_date"
							...
							<div class="col-md-6"><Geo :lockElement="loaderElement" :syncObject="diseño.geo_city_id" /></div>

							<div class="col-md-">
								<div class="form-group">
									<label>Gaceta industrial de publicación: </label>
									<DxTextBox placeholder="Gaceta industrial de publicación" class="form-control" :value.sync="diseño.Gazette_publication">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<DxTextArea :height="100" :max-length="400" :value.sync="diseño.observation" placeholder="Observacion" class="form-control">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextArea>
							...
							<div class="col-md-">
								<div class="form-group">
									<label>Activo: </label>
									<DxSwitch :value.sync="diseño.active" switched-on-text="SI" switched-off-text="NO" />
								</div>
							</div>
				...
				<div class="p-0">
					<div class="page-header header-elements-md-inline">
						...
						<div class="header-elements">
							<button type="button" @click.prevent="edit()" title="Nuevo Diseño Industrial.." class="btn btn-main btn-labeled btn-labeled-left " id="btn-add">
					...
					>
						...
						<DxSummary>
							<DxGroupItem summary-type="count" column="group_type_name" display-format="{0} Industriales" />
						</DxSummary>
						<DxPager
							:show-info="true"
							...
							info-text="Página {0} de {1} ({2} Industriales)"
						/>
						...
						<template #tpl="{ data }">
							<span class="cmds">
								<a title="Editar industrial..." class="cmd-item color-main-600" @click.prevent="edit(data.data)" href="#">
								...
								<!-- 
										...
										-->
								<a v-if="data.data.active" title="Desactivar industrial..." class="cmd-item color-main-600 mr-2" @click.prevent="active(data, false)" href="#">
									<i class="icon-database-remove"></i>
								</a>
								<a v-else title="Activar industrial..." class="cmd-item color-main-600 mr-2" @click.prevent="active(data, true)" href="#">
...
export default {
	...
	mounted() {
		...
		// root.loaderElement = "#panel-industrial";
		// this.loaderElement = ".card-body";
		this.loaderElement = "#panel-unidades .card-body";
		this.loaderMessage = "Cargando Industriales";
		root.panelData = $("#panel-industrial .data");
		root.panelGrid = $("#panel-industrial .grid");
		// console.clear();
	...
	methods: {
		...
		// ...mapActions("DiseñoIndustrial", { paperActive: "active" }),
		...
		active(data, state) {
			...
			let msg = `¿Realmente desea ${a} el industrial <span class='text-sb'>"${data.data.title}"</span>?`;
			this.$confirm(msg, function(si_no) {
				console.log("result", si_no);
				if (si_no) {
					// root.loaderMessage = `${am} industrial <span class='text-sb'>"${data.data.title}"</span>`;
