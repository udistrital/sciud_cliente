<template>
	<div class="col mt-3" id="panel-Software" v-if="editMode">
		<div class="row data slide">
			<div class="col">
				<div class="card">
					<div class="card-header main">
						<i class="icon-pencil3 mr-1 color-main-600"></i>
						<span class="font-weight-semibold">{{ editData ? "Editar" : "Crear" }} Software</span>
					</div>
					<div class="card-body mb-0 pb-0 pt-2">
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Titulo Software: </label>
									<DxTextBox placeholder="Titulo Software" class="form-control" :value.sync="paper.title">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<DxSelectBox
										...
										:search-enabled="false"
										placeholder="Seleccione..."
										:value.sync="paper.colciencias_call_id"
										class="form-control"
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<DxTextBox placeholder="Nombre Revista" class="form-control" :value.sync="paper.journal_name">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label>ISSN: </label>
									<DxTextBox placeholder="ISSN" class="form-control" :value.sync="paper.issn">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label>Web Software: </label>
									<DxTextBox placeholder="Web Software" class="form-control" :value.sync="paper.url">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label>DOI: </label>
									<DxTextBox placeholder="DOI" class="form-control" :value.sync="paper.doi">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-6"><Geo :lockElement="loaderElement" :syncObject="paper" /></div>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label>Activo: </label>
									<DxSwitch :value.sync="paper.Active" switched-on-text="SI" switched-off-text="NO" />
								</div>
							</div>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label>Volumen: </label>
									<DxTextBox placeholder="Volumen" class="form-control" :value.sync="paper.volume">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label>Cant Paginas: </label>
									<DxTextBox placeholder="Cant Paginas" class="form-control" :value.sync="paper.number_of_pages">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<DxDateBox
										class="form-control"
										name="approval_date"
										:value.sync="paper.approval_date"
										id="approval_date"
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<DxDateBox
										...
										:value.sync="paper.publication_date"
										id="publication_date"
										placeholder="yyyy-mm-dd"
										display-format="yyyy-MM-dd"
										:min="minDate"
							...
							<div class="col-md-2">
								<div class="form-group">
									<label>Pag Inicial: </label>
									<DxTextBox placeholder="Pag Inicial" class="form-control" :value.sync="paper.initial_page">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-2">
								<div class="form-group">
									<label>Pag Final: </label>
									<DxTextBox placeholder="Pag Final" class="form-control" :value.sync="paper.final_page">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<DxSelectBox
										...
										:search-enabled="false"
										placeholder="Seleccione..."
										:value.sync="paper.paper_type_id"
										class="form-control"
										:data-source="paper_type"
										display-expr="name"
										Value-expr="id "
									>
										<DxValidator>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<DxTextArea :height="100" :max-length="400" :value.sync="paper.observation" placeholder="Observaciones" class="form-control">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextArea>
				...
				<div class="p-0">
					<div class="page-header header-elements-md-inline">
						...
						<div class="header-elements">
							<button type="button" @click.prevent="edit()" title="Nuevo Software.." class="btn btn-main btn-labeled btn-labeled-left " id="btn-add">
					...
					>
						...
						<DxSummary>
							<DxGroupItem summary-type="count" column="group_type_name" display-format="{0} Softwares" />
						</DxSummary>
						<DxPager
							:show-info="true"
							...
							info-text="Página {0} de {1} ({2} Softwares)"
						/>
						...
						<template #tpl="{ data }">
							<span class="cmds">
								<a title="Editar Software..." class="cmd-item color-main-600" @click.prevent="edit(data.data)" href="#">
...
export default {
	...
	mounted() {
		...
		// root.loaderElement = "#panel-Software";
		// this.loaderElement = ".card-body";
		this.loaderElement = "#panel-unidades .card-body";
		this.loaderMessage = "Cargando Softwares";
		root.panelData = $("#panel-Software .data");
		root.panelGrid = $("#panel-Software .grid");
		// console.clear();
	...
	methods: {
		...
		...mapActions("Software", { paperActive: "active" }),
		...
		active(data, state) {
			...
			let msg = `¿Realmente desea ${a} el Software <span class='text-sb'>"${data.data.title}"</span>?`;
			this.$confirm(msg, function(si_no) {
				console.log("result", si_no);
				if (si_no) {
					// root.loaderMessage = `${am} Software <span class='text-sb'>"${data.data.title}"</span>`;
