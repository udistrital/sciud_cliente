<template>
	<div class="col p-3">
		<div class="text-center p-2 mb-2">
			<h3 class="font-weight-semibold text-success">Productos Empresariales</h3>
		</div>
		...
		<div class="row">
			...
			<div class="form-group col-md-12">
				<label>Número del Registro</label>
				<!-- <input type="text" class="form-control" /> -->
				<DxTextBox class="form-control" placeholder="Numero Registro" name="numRegistro" id="numRegistro" :showClearButton="true">
					<DxValidator>
						<DxValidationRule type="required" message="Falta Numero Registro" />
			...
			<div class="form-group col-md-12">
				...
				<!-- <input type="text" class="form-control" /> -->
				<DxTextBox class="form-control" placeholder="Titulo Registro" name="Registro" :showClearButton="true">
					<DxValidator>
						<DxValidationRule type="required" message="Falta Titulo Registro" />
						<DxRequiredRule message="Campo requerido" />
		...
		<div class="row">
			...
			<div class="col text-right">
				<a href="#" @click="save($event)" :class="'btn btn-main btn-labeled btn-labeled-right btn-sm legitRipple' + (isValid ? '' : ' disabled')">
					GUARDAR
					<b>
