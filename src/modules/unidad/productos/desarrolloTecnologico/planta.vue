<template>
	<div class="col mt-3" id="panel-Planta" v-if="editMode">
		<div class="row data slide">
			<div class="col">
				<div class="card">
					<div class="card-header main">
						<i class="icon-pencil3 mr-1 color-main-600"></i>
						<span class="font-weight-semibold">{{ editData ? "Editar" : "Crear" }} Planta piloto</span>
					</div>
					<div class="card-body mb-0 pb-0 pt-2">
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label>Nombre prototipo: </label>
									<DxTextBox placeholder="Nombre prototipo" class="form-control" :value.sync="planta.name_industrial_prot">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxTextBox placeholder="Fecha de elaboración" class="form-control" :value.sync="planta.date_elaboration">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxTextBox placeholder="Lugar de elaboración" class="form-control" :value.sync="planta.place_elaboration">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxTextBox placeholder="Institución financiadora" class="form-control" :value.sync="planta.financing_inst">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>Activo: </label>
									<DxSwitch :value.sync="planta.active" switched-on-text="SI" switched-off-text="NO" />
								</div>
							</div>

							<div class="col-md-3">
								<div class="form-group">
									<label>Copia Digital: </label>
									<a
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<DxTextArea :height="100" :max-length="400" :value.sync="planta.observation" placeholder="Observacion" class="form-control">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextArea>
			...
			<div class="col">
				<div class="p-0">
					<div class="page-header header-elements-md-inline">
						<div class="page-title d-flex">
							<h1>
								...
								<span class="font-weight-semibold">Planta Piloto</span>
							</h1>
						</div>
						<div class="header-elements">
							<button type="button" @click.prevent="edit()" title="Nueva Planta piloto.." class="btn btn-main btn-labeled btn-labeled-left " id="btn-add">
								<b><i class="icon-database-add"></i></b> Nueva Planta piloto
							</button>
						</div>
					</div>
					...
					>
						...
						<DxSummary>
							<DxGroupItem summary-type="count" column="group_type_name" display-format="{0} Plantas" />
						</DxSummary>
						<DxPager
							:show-info="true"
							...
							info-text="Página {0} de {1} ({2} Plantas)"
						/>
						...
						<template #tpl="{ data }">
							<span class="cmds">
								<a title="Editar Planta..." class="cmd-item color-main-600" @click.prevent="edit(data.data)" href="#">
...
export default {
	...
	mounted() {
		...
		// root.loaderElement = "#panel-Planta";
		// this.loaderElement = ".card-body";
		this.loaderElement = "#panel-unidades .card-body";
		this.loaderMessage = "Cargando Plantas";
		root.panelData = $("#panel-Planta .data");
		root.panelGrid = $("#panel-Planta .grid");
		// console.clear();
	...
	methods: {
		...
		// ...mapActions("Plantapiloto", { paperActive: "active" }),
		...
		active(data, state) {
			...
			let msg = `¿Realmente desea ${a} el Planta <span class='text-sb'>"${data.data.title}"</span>?`;
			this.$confirm(msg, function(si_no) {
				console.log("result", si_no);
				if (si_no) {
					// root.loaderMessage = `${am} Planta <span class='text-sb'>"${data.data.title}"</span>`;
