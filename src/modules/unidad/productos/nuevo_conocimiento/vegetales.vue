...
<template>
	<div class="col mt-3 pl-1 pr-1" id="panelvegvariet">
					...
					<div class="page-header header-elements-md-inline mb-2">
						<div class="page-title p-0 m-0">
							<h1>
								...
								<span class="font-weight-semibold">Variedad Vegetal</span>
						...
						<div class="header-elements">
							...
							<span class="cmds-back slide">
								<button type="button" @click.prevent="retorno()" title="Volver al Variedad Vegetal.." class="btn btn-main btn-labeled btn-labeled-left ">
									<b><i class="icon-arrow-left"></i></b> Volver A Variedad Vegetal
								</button>
							</span>
						</div>
					</div>
		...
		<Participantes id="panelvegvariet-participantes" end-point="vegetable_varieties" :product="baseObj" :group="group" ref="participantes" :parent="this" />
				...
				<div class="col">
					<div class="card">
						<div class="card-header main">
							...
							<span class="font-weight-semibold">{{ mode == "edit" ? "Editar" : "Crear" }} Variedad Vegetal</span>
						</div>
...
export default {
	...
	created() {
		...
		// root.tipociclo = root.subtypesByType("Variedad_vegeral_tipo");
		root.statepeticion = root.subtypesByType("variedad_vegetal_estado_peticion");
		root.subtipos = root.subtypesByType("variedad_vegetal_categoria");
		root.tiposDocumento = root.subtypesByType("variedad_vegetal_documento");
	},
	mounted() {
		//root.getConvocatorias();
	...
	methods: {
		...
		participantes(data) {
			...
			root.panelGrid.fadeOut(function(params) {
				...
				$("#panelvegvariet-participantes .grid").fadeIn();
		...
		documentos(data) {
			...
			root.panelGrid.fadeOut(function(params) {
				root.panelCmdBack.fadeIn();
				$("#panelvegvariet-documentos").fadeIn(function(params) {});
			});
		},
		...
		retorno() {
			...
			if (root.section == "participantes") {
				...
				$("#panelvegvariet-documentos").fadeOut(function(params) {
					root.panelCmds.fadeIn();
					root.panelGrid.fadeIn(function(params) {});
				});
			}
			$("#panelvegvariet .item-title").html("");
