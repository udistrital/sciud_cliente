...
<template>
	<div class="col mt-3 pl-1 pr-1" id="panelNuevaPecuaria">
		<div class="row">
			<div class="col">
				<div class="p-0">
		...
		<Documentos id="panelNuevaPecuaria-documentos" end-point="ip_livestock_breeds" :main-obj="baseObj" :parent="this" :tipos="tiposDocumento" />
		<Participantes id="panelNuevaPecuaria-participantes" end-point="ip_livestock_breeds" :product="baseObj" :group="group" ref="participantes" :parent="this" />
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<DxTextBox placeholder="Numero Consecutivo" class="form-control" :value.sync="baseObj.consecutive_number_ma">
											<DxValidator>
												<DxRequiredRule />
											</DxValidator>
										</DxTextBox>
			...
			<div class="col">
				<div class="p-0">
					...
					>
						...
						<DxColumn data-field="consecutive_number_ma" caption="Consecutivo" data-type="string" alignment="center" :visible="true" :allow-grouping="false" />
						<DxColumn data-field="publication_date" caption="Fecha Publicación" data-type="String" alignment="center" :visible="true" :allow-grouping="true" />
...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("raza_pecuaria_categoria");
		root.tiposDocumento = root.subtypesByType("raza_pecuaria_documento");
	},
	mounted() {
		//root.getConvocatorias();
		...
		root.panelData = $("#panelNuevaPecuaria .data");
		root.panelGrid = $("#panelNuevaPecuaria .grid");
		root.panelCmds = $("#panelNuevaPecuaria .cmds");
		root.panelCmdBack = $("#panelNuevaPecuaria .cmds-back");
		root.panelDocs = $("#panelNuevaPecuaria-documentos");
		root.loaderMessage = "Cargando elementos";
		root.loaderElement = "#panelNuevaPecuaria .grid";
	},
	computed: {
		...
		dataSource: function() {
			...
			return DxStore({
				key: ["id"],
				endPoint: `research_units/${root.group.id}/ip_livestock_breeds`,
	...
	methods: {
		...
		participantes(data) {
			...
			root.panelGrid.fadeOut(function(params) {
				...
				$("#panelNuevaPecuaria-participantes .grid").fadeIn();
		...
		documentos(data) {
			...
			root.panelGrid.fadeOut(function(params) {
				root.panelCmdBack.fadeIn();
				$("#panelNuevaPecuaria-documentos").fadeIn(function(params) {});
			});
		},
		...
		retorno() {
			...
			if (root.section == "participantes") {
				...
				$("#panelNuevaPecuaria-documentos").fadeOut(function(params) {
					root.panelCmds.fadeIn();
					root.panelGrid.fadeIn(function(params) {});
				});
			}
			$("#panelNuevaPecuaria .item-title").html("");
		...
		save() {
			...
			if (result.isValid) {
				...
				let dto = {
					...
					stringEP: "ip_livestock_breeds",
					mod: obj.id,
					objectSend: { ip_livestock_breed: obj },
					cb: function(item) {
