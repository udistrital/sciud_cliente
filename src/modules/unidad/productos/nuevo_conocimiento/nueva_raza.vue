\* data.row.data.name = titulo de participantes data.data.name = titulo para activar o desactivar Nueva Raza Animal = Titulo botones Nueva Raza Animal = Titulo
principal Raza = titulo abreviado panelrazaanimal = nombredepaneles new_animal_breed = endpoindt especifico new_animal_breeds = rutas generales *\
<template>
						...
						<div class="header-elements">
							<span class="cmds">
								<button
									...
									@click.prevent="add()"
									v-if="editMode"
									title="Ingresar Nueva Raza Animal.."
