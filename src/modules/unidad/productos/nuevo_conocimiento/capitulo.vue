						...
						<div class="header-elements">
							<span class="cmds">
								<button
									...
									@click.prevent="add()"
									v-if="editMode"
									title="Ingresar Capítulo de Libro.."
			...
			<div class="col">
				<div class="p-0">
					...
					>
						...
						<DxColumn data-field="colciencias_call_name" caption="Convocatoria" data-type="string" alignment="center" :visible="false" :allow-grouping="true" />
