/* Elementos a remplazar: Maestria = Titulos Principales de la aplicacion en singular una palabra Nueva Maestria = Son para los botones de nuevo elemento
Maestria = titulo abrebiado de la del contenido a mostrar maestriajs = nombre del archivo store al cual esta configurado axios research_units= ruta principal
del modulo en el endPoint master = objeto json al cual se enviaran los datos de formulario */

<template>
	<div class="col mt-3" id="panel-Maestria" v-if="editMode">
		<div class="row data slide">
			<div class="col">
				<div class="card">
					<div class="card-header main">
						<i class="icon-pencil3 mr-1 color-main-600"></i>
						<span class="font-weight-semibold">{{ editData ? "Editar" : "Crear" }} Maestria</span>
					</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Título: </label>
									<DxTextBox placeholder="Título" class="form-control" :value.sync="master.title">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label>Autor: </label>
									<DxTextBox placeholder="Autor" class="form-control" :value.sync="master.Author">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<DxTextBox placeholder="Institución" class="form-control" :value.sync="master.institution">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<DxTextBox placeholder="Director" class="form-control" :value.sync="master.director">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<DxTextBox placeholder="Codirector" class="form-control" :value.sync="master.codirector">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label>Tutor: </label>
									<DxTextBox placeholder="Tutor" class="form-control" :value.sync="master.tutor">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxSelectBox
										...
										:search-enabled="false"
										placeholder="Seleccione..."
										:value.sync="master.colciencias_call_id"
										class="form-control"
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>Codirectores: </label>
									<DxTextBox placeholder="Codirectores" class="form-control" :value.sync="master.codirectors">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxTextBox placeholder="Reconocimientos" class="form-control" :value.sync="master.recognition">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>: </label>
									<DxSwitch :value.sync="master.active" switched-on-text="SI" switched-off-text="NO" />
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<DxTextArea :height="100" :max-length="400" :value.sync="master.Observation" placeholder="Observaciones" class="form-control">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextArea>
				...
				<div class="p-0">
					<div class="page-header header-elements-md-inline">
						...
						<div class="header-elements">
							<button type="button" @click.prevent="edit()" title="Nueva Maestria.." class="btn btn-main btn-labeled btn-labeled-left " id="btn-add">
								<b><i class="icon-database-add"></i></b>Nueva Maestria
							</button>
						</div>
					</div>
					...
					>
						...
						<DxSummary>
							<DxGroupItem summary-type="count" column="group_type_name" display-format="{0} Maestria" />
						</DxSummary>
						<DxPager
							:show-info="true"
							...
							info-text="Página {0} de {1} ({2} Maestria)"
						/>
						...
						<template #tpl="{ data }">
							<span class="cmds">
								<a title="Editar Maestria..." class="cmd-item color-main-600" @click.prevent="edit(data.data)" href="#">
								...
								-->
								<a v-if="data.data.active" title="Desactivar Maestria..." class="cmd-item color-main-600 mr-2" @click.prevent="active(data, false)" href="#">
									<i class="icon-database-remove"></i>
								</a>
								<a v-else title="Activar Maestria..." class="cmd-item color-main-600 mr-2" @click.prevent="active(data, true)" href="#">
...
export default {
	...
	mounted() {
		// console.clear();
		root = this;
		// root.loaderElement = "#panel-Maestria";
		// this.loaderElement = ".card-body";
		this.loaderElement = "#panel-unidades .card-body";
		this.loaderMessage = "Cargando Maestria";
		root.panelData = $("#panel-Maestria .data");
		root.panelGrid = $("#panel-Maestria .grid");
		// console.clear();
	...
	computed: {
		dataSource: function() {
			...
			return DxStore({
				key: ["id"],
				endPoint: `research_units/${root.group.id}/masters`,
				// endPoint: `research_units/masters`,
	...
	methods: {
		...
		// ...mapActions("maestriajs", { masterActive: "active" }),
		// ...mapActions("maestriajs", ["all", "saveChange", "updateChange"]),
		...
		active(data, state) {
			...
			this.$confirm(msg, function(si_no) {
				...
				if (si_no) {
					...
					root.loadShow();
					var dto = {
						url: `research_units/${root.group.id}/masters/${data.data.id}/active`,
						master: {
							master: {
								active: state,
								updated_by: 1,
