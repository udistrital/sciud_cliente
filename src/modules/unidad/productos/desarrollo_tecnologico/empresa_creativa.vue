...
Empresas Creativas y Culturales  = Titulo botones 
Empresas Creativas y Culturales  = Titulo principal 
					...
					<div class="page-header header-elements-md-inline mb-2">
						<div class="page-title p-0 m-0">
							<h1>
								...
								<span class="font-weight-semibold">Empresas Creativas y Culturales  </span>
								<span class="item-title">&nbsp;</span>
							</h1>
						</div>
						<div class="header-elements">
							<span class="cmds">
								<button type="button" @click.prevent="add()" v-if="editMode"  title="Nueva Empresas Creativas y Culturales .." class="btn btn-main btn-labeled btn-labeled-left ">
									<b><i class="icon-database-add"></i></b> Nueva Empresa
								</button>
							</span>
							<span class="cmds-back slide">
								<button type="button" @click.prevent="retorno()" title="Volver al Empresas Creativas y Culturales .." class="btn btn-main btn-labeled btn-labeled-left ">
				...
				<div class="col">
					<div class="card">
						<div class="card-header main">
							...
							<span class="font-weight-semibold">{{ mode == "edit" ? "Editar" : "Crear" }} Empresas Creativas y Culturales </span>
						</div>
...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("empresa_creativa_categoria");
		root.tiposDocumento = root.subtypesByType("empresa_creativa_documento");
	},
	mounted() {
