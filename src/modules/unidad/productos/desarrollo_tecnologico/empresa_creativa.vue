\* data.name=titulo para activar o desactivar Empresas Creativas y Culturales = Titulo botones Empresas Creativas y Culturales = Titulo principal
Innovacion_generada=titulo abreviado panelEmpresabase=nombredepaneles enterprises = enterprise enlace enterprise=endpoindt especifico endpoinds tutas generales
update *\
<template>
						...
						<div class="header-elements">
							<span class="cmds">
								<button
									...
									@click.prevent="add()"
									v-if="editMode"
									title="Nueva Empresas Creativas y Culturales .."
							...
							<span class="cmds-back slide">
								<button
									...
									title="Volver al Empresas Creativas y Culturales .."
									class="btn btn-main btn-labeled btn-labeled-left "
								>
