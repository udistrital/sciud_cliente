...
<div class="col-md-4">
	...
	<label>Nombre: </label>
	<DxTextBox placeholder="Nombre" class="form-control" :value.sync="baseObj.title">
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxTextBox>
			...
			<div class="col">
				<div class="p-0">
					...
					>
						...
						<DxColumn data-field='colciencias_call_year'  caption='Minciencias Año' data-type='string' alignment='center' :visible='true' :allow-grouping='true' /> 
...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("proyecto_ley_categoria");
		root.tiposDocumento = root.subtypesByType("proyecto_ley_documento");
	},
	mounted() {
