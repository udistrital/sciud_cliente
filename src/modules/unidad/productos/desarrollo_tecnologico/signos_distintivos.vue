\* data.registration_title=titulo para activar o desactivar Signos Distintivos = Titulo botones Signos Distintivos = Titulo principal Signos=titulo abreviado
panelSignosDistintivos=nombredepaneles distinctive_signs = endpoint enlace distinctive_sign=endpoindt especifico endpoinds tutas generales update *\
<template>
						...
						<div class="header-elements">
							<span class="cmds">
								<button
									...
									@click.prevent="add()"
									v-if="editMode"
									title="Nuevo Signos Distintivos.."
			...
			<div class="col">
				<div class="p-0">
					...
					>
						...
						<DxColumn
							data-field="registration_title"
							caption="Titulo del Registro"
							data-type="string"
							alignment="center"
							:visible="true"
						...
						/>
						<DxColumn
							data-field="registration_number"
	...
	methods: {
		...
		participantes(data) {
			...
			$("#panelSignosDistintivos .item-title").html(
				`<span class="font-weight-semibold"> &raquo; Participantes</span> &raquo; ${data.row.data.registration_title}`
			);
		...
		documentos(data) {
			...
			root.baseObj = rd;
			$("#panelSignosDistintivos .item-title").html(
				`<span class="font-weight-semibold"> &raquo; Documentos</span> &raquo;  ${data.row.data.registration_title}`
			);
			root.panelCmds.fadeOut();
			root.panelGrid.fadeOut(function(params) {
				root.panelCmdBack.fadeIn();
