\* data.name=titulo para activar o desactivar Innovación en procedimiento y servicio = Titulo botones Innovación en procedimiento y servicio = Titulo principal
Innovacion_generada=titulo abreviado panelInnovacion_procedimiento=nombredepaneles innovations = innovation enlace innovation=endpoindt especifico endpoinds
tutas generales update *\
<template>
	<div class="col mt-3 pl-1 pr-1" id="panelInnovacion_procedimiento">
						...
						<div class="header-elements">
							<span class="cmds">
								<button
									...
									@click.prevent="add()"
									v-if="editMode"
									title="Nueva Innovación en procedimiento y servicio .."
							...
							<span class="cmds-back slide">
								<button
									...
									title="Volver al Innovación en procedimiento y servicio .."
									class="btn btn-main btn-labeled btn-labeled-left "
								>
		...
		<Participantes
			id="panelInnovacion_procedimiento-participantes"
			end-point="innovations"
			:product="baseObj"
			:group="group"
			ref="participantes"
			:parent="this"
						...
						<template #tpl="{ data }">
							<span class="cmds">
								...
								<a
									...
									title="Desactivar Innovacion_generada..."
									class="cmd-item color-main-600 mr-2"
