			...
			<div class="col">
				<div class="p-0">
					...
					>
						...
						<DxColumn data-field='product_type_name'  caption='producto' data-type='string' alignment='center' :visible='false' :allow-grouping='false' /> 
...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("protocolo_vigilancia_categoria");
		root.tiposDocumento = root.subtypesByType("protocolo_vigilancia_documento");
	},
	mounted() {
