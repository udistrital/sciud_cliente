...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("acto_legislativo_categoria");
		root.tiposDocumento = root.subtypesByType("acto_legislativo_documento");
	},
	mounted() {
