\* data.title=titulo para activar o desactivar Normas = Titulo botones Normas = Titulo principal Normas=titulo abreviado panelNormas=nombredepaneles regulations
= regulation enlace regulation=endpoindt especifico endpoinds tutas generales update *\
<template>
