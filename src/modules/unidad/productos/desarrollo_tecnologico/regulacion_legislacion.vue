\* data.title=titulo para activar o desactivar Legislaciones = Titulo botones Legislaciones = Titulo principal Legislaciones=titulo abreviado
panelLegislaciones=nombredepaneles regulations = regulation enlace regulation=endpoindt especifico endpoinds tutas generales update *\
<template>
						...
						<template #tpl="{ data }">
							<span class="cmds">
								...
								<a
									...
									title="Desactivar Legislaciones..."
									class="cmd-item color-main-600 mr-2"
