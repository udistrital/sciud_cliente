\* data.name=titulo para activar o desactivar Empresa de base tecnológica (Spin- off y Start-up) = Titulo botones Empresa de base tecnológica (Spin- off y
Start-up) = Titulo principal Innovacion_generada=titulo abreviado panelEmpresabase=nombredepaneles enterprises = enterprise enlace enterprise=endpoindt
especifico endpoinds tutas generales update *\
<template>
						...
						<div class="header-elements">
							<span class="cmds">
								<button
									...
									@click.prevent="add()"
									v-if="editMode"
									title="Nueva Empresa de base tecnológica (Spin- off y Start-up)  .."
							...
							<span class="cmds-back slide">
								<button
									...
									title="Volver al Empresa de base tecnológica (Spin- off y Start-up)  .."
									class="btn btn-main btn-labeled btn-labeled-left "
								>
