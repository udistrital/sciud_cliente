...
Regulaciones  = Titulo botones 
Regulaciones  = Titulo principal 
Regulaciones=titulo abreviado
panelRegulaciones=nombredepaneles
					...
					>
						...
						<template #tpl="{ data }">
							<span class="cmds">
								...
								<a v-if="data.data.active" title="Desactivar Regulaciones..." class="cmd-item color-main-600 mr-2" @click.prevent="active(data, false)" href="#">
