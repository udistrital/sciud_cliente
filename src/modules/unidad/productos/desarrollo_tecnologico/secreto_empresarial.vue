\* data.name=titulo para activar o desactivar Secreto Empresarial = Titulo botones Secreto Empresarial = Titulo principal Coleccion=titulo abreviado
panelcolec=nombredepaneles enterprise_secrets = enterprise_secret enlace enterprise_secret=endpoindt especifico endpoinds tutas generales update *\
<template>
						...
						<div class="header-elements">
							<span class="cmds">
								<button
									...
									@click.prevent="add()"
									v-if="editMode"
									title="Nuevo Secreto Empresarial.."
