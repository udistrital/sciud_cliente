...
<div class='col-md-3'>
	...
	<DxTextBox placeholder='Nombre Programa' class='form-control' :value.sync='baseObj.program_name'>
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxTextBox>
...
<div class='col-md-3'>
	...
	<DxTextBox placeholder='Institucion' class='form-control' :value.sync='baseObj.institution'>
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxTextBox>
...
<div class='col-md-3'>
	<div class='form-group'>
	<label>Numero Acto Admin: </label>
	<DxNumberBox placeholder='Numero Acto Admin' class='form-control' :value.sync='baseObj.num_administrative_act' />
	<DxValidator> 
		<DxRequiredRule />
	</DxValidator> 
	</div>
...
<div class='col-md-3'>
	<div class='form-group'>
	<label>identificación del acto administrativo: </label>
	<DxTextBox placeholder='identificación del acto administrativo' class='form-control' :value.sync='baseObj.id_administrative_act'>
	<DxValidator>
	</DxValidator>
	</DxTextBox>
	</div>
...
<div class='col-md-3'>
	...
	<DxTextBox placeholder='Facultad' class='form-control' :value.sync='baseObj.faculty'>
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxTextBox>
			...
			<div class="col">
				...
				<div class="p-0">
					...
					>
						...
						<DxColumn data-field='program_name'  caption='Nombre Programa' data-type='String' alignment='center' :visible='true' :allow-grouping='false' /> 
						<DxColumn data-field='faculty'  caption='Facultad' data-type='String' alignment='center' :visible='true' :allow-grouping='false' /> 
						<DxColumn data-field='institution'  caption='Institución' data-type='String' alignment='center' :visible='true' :allow-grouping='false' /> 
						<DxColumn data-field='id_administrative_act'  caption='Identificación Administrativa' data-type='String' alignment='center' :visible='true' :allow-grouping='false' /> 
						<DxColumn data-field='date'  caption='Fecha' data-type='String' alignment='center' :visible='true' :allow-grouping='false' /> 
						<DxColumn data-field='num_administrative_act'  caption='Núm. Actividad Administrativo' data-type='String' alignment='center' :visible='false' :allow-grouping='false' /> 
...
export default {
	...
	data: () => ({
		...
		baseObj: {
			...
			geo_country_id: null,
			geo_state_id: null,
			id_administrative_act: null,
			institution: null,
			num_administrative_act: null,
			observation: null,
			program_name: null,
	...
	created() {
		...
		root.subtipos = root.subtypesByType("apoyo_creacion_categoria");
		root.tiposDocumento = root.subtypesByType("apoyo_creacion_documento");
