			...
			<div class="col">
				...
				<div class="p-0">
					...
					>
						...
						<DxColumn
							data-field="name_ext_project"
							caption="Nombre Proyecto Ext"
							data-type="String"
							alignment="center"
							:visible="false"
...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("proyecto_extension_categoria");
		root.tiposDocumento = root.subtypesByType("proyecto_extension_documento");
