...
export default {
	...
	data: () => ({
		namePanel:"proyecto_investigacion_creacion",
        codEP: 636, //636
        popupObs: false,
        observarData:"",
	...
	created() {
		...
		root.subtipos = root.subtypesByType("proyecto_investigacion_creacion_categoria");
		root.tiposDocumento = root.subtypesByType("proyecto_investigacion_creacion_documento");
