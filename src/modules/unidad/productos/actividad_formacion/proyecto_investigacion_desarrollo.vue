...
<div class='col-md-4'>
	<div class='form-group'>
	<label>Institucuon Financiadora: </label>
	<DxTextBox placeholder='Institucuon Financiadora' class='form-control' :value.sync='baseObj.funding_institution'>
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxTextBox>
...
<div class='col-md-4'>
	<div class='form-group'>
	<label>Institucuon: </label>
	<DxTextBox placeholder='Institucuon' class='form-control' :value.sync='baseObj.institution'>
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxTextBox>
...
export default {
	...
	data: () => ({
		namePanel:"proyecto_investigacion_desarrollo",
        codEP: 635, //636
        popupObs: false,
        observarData:"",
	...
	created() {
		...
		root.subtipos = root.subtypesByType("proyecto_investigacion_desarrollo_categoria");
		root.tiposDocumento = root.subtypesByType("proyecto_investigacion_desarrollo_documento");
