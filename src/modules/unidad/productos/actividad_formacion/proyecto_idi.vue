	...
	<DxValidator> 
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<DxNumberBox placeholder="Numero de Contrato" class="form-control" :value.sync="baseObj.contract_number" />
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>Istitucion Financiadora: </label>
										<DxTextBox placeholder="Istitucion Fundadora" class="form-control" :value.sync="baseObj.funding_institution">
											<DxValidator>
												<DxRequiredRule />
											</DxValidator>
										</DxTextBox>
			...
			<div class="col">
				...
				<div class="p-0">
					...
					>
						...
						<DxColumn data-field="year" caption="Fecha" data-type="String" alignment="center" :visible="true" :allow-grouping="false" />
						...
						<DxColumn
							...
							caption="Institucion Financiadora"
							data-type="String"
							alignment="center"
							:visible="true"
							:allow-grouping="false"
						/>
						<DxColumn data-field="category_id" caption="Categoria" data-type="String" alignment="center" :visible="false" :allow-grouping="false" />
...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("proyecto_idi_categoria");
		root.tiposDocumento = root.subtypesByType("proyecto_idi_documento");
