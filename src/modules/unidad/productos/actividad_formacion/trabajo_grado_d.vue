<template>
	<div class="col mt-3 pl-1 pr-1" id="paneltrabajosd">
		...
		<Documentos id="paneltrabajosd-documentos" end-point="degree_works" :main-obj="baseObj" :parent="this" :tipos="tiposDocumento" />
		<Participantes id="paneltrabajosd-participantes" end-point="degree_works" :product="baseObj" :group="group" ref="participantes" :parent="this" />
...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("trabajo_grado_d_categoria");
		root.tiposDocumento = root.subtypesByType("trabajo_grado_d_documento");
	},
	mounted() {
		// root.getConvocatorias();
	...
	methods: {
		...
		participantes(data) {
			...
			$("#paneltrabajosd .item-title").html(`<span class="font-weight-semibold"> &raquo; Participantes</span> &raquo; ${data.row.data.dw_title}`);
			root.panelParticipantes = $("#paneltrabajosd-participantes");
			console.log("root.panelParticipantes", root.panelParticipantes.length);
			$("#paneltrabajosd-documentos").hide();
			root.panelGrid.fadeOut(function(params) {
				root.panelCmdBack.fadeIn();
				$("#paneltrabajosd-participantes .grid").fadeIn();
		...
		documentos(data) {
			...
			console.log("rd", rd);
			root.baseObj = rd;
			$("#paneltrabajosd .item-title").html(`<span class="font-weight-semibold"> &raquo; Documentos</span> &raquo; ${data.row.data.dw_title}`);
			root.panelCmds.fadeOut();
			root.panelGrid.fadeOut(function(params) {
				root.panelCmdBack.fadeIn();
