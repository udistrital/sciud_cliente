/* Elementos a remplazar: Proyectos = Titulos Principales de la aplicacion en singular una palabra Nuevo Desarrollo e Innovación = Son para los botones de nuevo
elemento Desarrollo e Innovación = titulo abrebiado de la del contenido a mostrar desarrolloInnovaciónjs = nombre del archivo store al cual esta configurado
axios research_units= ruta principal del modulo en el endPoint development_innovation = objeto json al cual se enviaran los datos de formulario */

<template>
	<div class="col mt-3" id="panel-Proyectos" v-if="editMode">
		<div class="row data slide">
			<div class="col">
				<div class="card">
					<div class="card-header main">
						<i class="icon-pencil3 mr-1 color-main-600"></i>
						<span class="font-weight-semibold">{{ editData ? "Editar" : "Crear" }} Proyectos</span>
					</div>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label>Título: </label>
									<DxTextBox placeholder="Título" class="form-control" :value.sync="development_innovation.title">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxTextBox placeholder="Institución" class="form-control" :value.sync="development_innovation.institution">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxTextBox placeholder="Investigador Principal" class="form-control" :value.sync="development_innovation.principal_investigator">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxTextBox placeholder="Entidad Financiadora" class="form-control" :value.sync="development_innovation.financing_entity">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxTextBox placeholder="Asignación del recurso" class="form-control" :value.sync="development_innovation.asignación_del_recurso">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextBox>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxDateBox
										class="form-control"
										name="date"
										:value.sync="development_innovation.date"
										id="date"
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxSelectBox
										...
										:value.sync="development_innovation.category_id"
										class="form-control"
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<DxSelectBox
										...
										:search-enabled="false"
										placeholder="Seleccione..."
										:value.sync="development_innovation.colciencias_call_id"
										class="form-control"
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>Número del contrato de beca-pasantía: </label>
									<DxTextBox
										placeholder="Número del contrato de beca-pasantía"
										class="form-control"
										:value.sync="development_innovation.number_contract_scholarship"
									>
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>: </label>
									<DxSwitch :value.sync="development_innovation.active" switched-on-text="SI" switched-off-text="NO" />
								</div>
							</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<DxTextArea :height="100" :max-length="400" :value.sync="development_innovation.observation" placeholder="Observacion" class="form-control">
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</DxTextArea>
			...
			<div class="col">
				<div class="p-0">
					<div class="page-header header-elements-md-inline">
						...
						<div class="header-elements">
							<button
								type="button"
								@click.prevent="edit()"
								title="Nuevo Desarrollo e Innovación.."
								class="btn btn-main btn-labeled btn-labeled-left "
								id="btn-add"
							>
								<b><i class="icon-database-add"></i></b>Nuevo Desarrollo e Innovación
							</button>
						</div>
					</div>
					...
					>
						...
						<DxSummary>
							<DxGroupItem summary-type="count" column="group_type_name" display-format="{0} Proyectos" />
						</DxSummary>
						<DxPager
							:show-info="true"
							...
							info-text="Página {0} de {1} ({2} Proyectos)"
						/>
						...
						<template #tpl="{ data }">
							<span class="cmds">
								...
								-->
								<a v-if="data.data.active" title="Desactivar Proyectos..." class="cmd-item color-main-600 mr-2" @click.prevent="active(data, false)" href="#">
									<i class="icon-database-remove"></i>
								</a>
								<a v-else title="Activar Proyectos..." class="cmd-item color-main-600 mr-2" @click.prevent="active(data, true)" href="#">
...
export default {
	...
	data: () => ({
		...
		development_innovation: {
			...
			asignación_del_recurso: null,
			date: null,
			category_id: null,
			colciencias_call_id: null,
			number_contract_scholarship: null,
			document: null,
			active: false,
			observation: null,
			created_by: null,
	...
	mounted() {
		// console.clear();
		root = this;
		// root.loaderElement = "#panel-Proyectos";
		// this.loaderElement = ".card-body";
		this.loaderElement = "#panel-unidades .card-body";
		this.loaderMessage = "Cargando Desarrollo e Innovación";
		root.panelData = $("#panel-Proyectos .data");
		root.panelGrid = $("#panel-Proyectos .grid");
		// console.clear();
	...
	computed: {
		dataSource: function() {
			...
			return DxStore({
				key: ["id"],
				endPoint: `research_units/${root.group.id}/development_innovations`,
				// endPoint: `research_units/development_innovations`,
	...
	methods: {
		...
		...mapActions("desarrolloInnovaciónjs", { development_innovationActive: "active" }),
		...mapActions("desarrolloInnovaciónjs", ["all", "saveChange", "updateChange"]),

		save() {
			let args = {
				unidadId: root.group.id,
				data: root.development_innovation,
			};
			...
			if (this.editData) {
				...
				console.log(this.development_innovation);
				this.$alert("Datos guardados con exito!");
			}

			this.editData = false;
			this.development_innovation = {};
		...
		edit(data) {
			...
			root.development_innovation = data;
		...
		active(data, state) {
			...
			this.$confirm(msg, function(si_no) {
				...
				if (si_no) {
					...
					root.loadShow();
					var dto = {
						url: `research_units/${root.group.id}/development_innovations/${data.data.id}/active`,
						development_innovation: {
							development_innovation: {
								active: state,
								updated_by: 1,
					...
					console.log("dto", dto);
					root.development_innovationActive(dto);
				}
			});
		},
