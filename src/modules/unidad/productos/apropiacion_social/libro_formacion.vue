...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("Libros_formación_apropiacion_categoria");
		root.tiposDocumento = root.subtypesByType("Libros_formación_apropiacion_documento");
