...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("libros_formacion_apropiacion_categoria");
		root.tiposDocumento = root.subtypesByType("libros_formacion_apropiacion_documento");
