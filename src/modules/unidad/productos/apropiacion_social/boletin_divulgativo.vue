...
<div class="col-md-4">
	...
	<DxTextBox placeholder="Institución " class="form-control" :value.sync="baseObj.institution">
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxTextBox>
			...
			<div class="col">
				...
				<div class="p-0">
					...
					>
                        ...
                        <DxColumn data-field='elaboration_date'  caption='Fecha' data-type='String' alignment='center' :visible='true' :allow-grouping='false' /> 
...
export default {
	...
	created() {
		...
		// root.tipox = root.subtypesByType("boletin_divulgativo_tipo");
		root.subtipos = root.subtypesByType("boletin_divulgativo_categoria");
		root.tiposDocumento = root.subtypesByType("boletin_divulgativo_documento");
