							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<DxTextBox placeholder="Nombre del Producto" class="form-control" :value.sync="baseObj.name">
											<DxValidator>
												<DxRequiredRule />
											</DxValidator>
										</DxTextBox>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>Ruta de Circulación: </label>
										<DxTextBox placeholder="Ruta de Circulación" class="form-control" :value.sync="baseObj.circulation_route">
								...
								<div class="col-md-2">
									<div class="form-group">
										<label>Fecha de Desarrollo o Inicio: </label>
										<DxDateBox
								...
								<div class="col-md-1">
									<div class="form-group">
										<label>Tiempo: </label>
										<DxNumberBox placeholder="Tiempo" class="form-control" :value.sync="baseObj.duration" />
										<DxValidator>
											<DxRequiredRule />
										</DxValidator>
									</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<DxSelectBox
											...
											:search-enabled="false"
											placeholder="Seleccione..."
											:value.sync="baseObj.duration_type_id"
											class="form-control"
											:data-source="duracion"
											display-expr="st_name"
											value-expr="id"
										>
										</DxSelectBox>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<DxTextBox placeholder="Institución Financiadora" class="form-control" :value.sync="baseObj.funding_institution">
											<DxValidator>
												<DxRequiredRule />
											</DxValidator>
										</DxTextBox>
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<DxTextBox placeholder="URL publicación" class="form-control" :value.sync="baseObj.url">
											<DxValidator>
												<DxRequiredRule />
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<DxTextArea :height="100" :max-length="400" :value.sync="baseObj.target_audiences" placeholder="Público Objetivo" class="form-control">
											<DxValidator> </DxValidator>
										</DxTextArea>
									</div>
								</div>
			...
			<div class="col">
				...
				<div class="p-0">
					...
					>
						...
						<DxColumn data-field="name" caption="Nombre Publicación" data-type="String" alignment="center" :visible="true" :allow-grouping="false" />

						<DxColumn data-field="circulation_route" caption="Ruta Circulación" data-type="String" alignment="center" :visible="true" :allow-grouping="false" />
						<DxColumn data-field="final_date" caption="Fecha Final" data-type="String" alignment="center" :visible="true" :allow-grouping="false" />
						<DxColumn
							data-field="funding_institution"
						...
						/>
						<!-- <DxColumn data-field='target_audiences'  caption='Objetivo' data-type='String' alignment='center' :visible='false' :allow-grouping='false' />  -->

						<DxColumn data-field="duration_type_name" caption="Tipo Duracion" data-type="String" alignment="center" :visible="false" :allow-grouping="false" />
						<DxColumn data-field="duration" caption="Tiempo Duracion" data-type="String" alignment="center" :visible="false" :allow-grouping="false" />

						<DxColumn data-field="start_date" caption="Fecha Inicio" data-type="String" alignment="center" :visible="false" :allow-grouping="false" />
						<DxColumn data-field="category_name" caption="Categoría" data-type="String" alignment="center" :visible="false" :allow-grouping="false" />
						...
						<template #tplObj="{ data }">
							<a
								v-if="data.data.target_audiences != '' && data.data.target_audiences != null"
								:title="data.data.target_audiences"
								class="cmd-item color-main-600 mr-2"
								@click.prevent="verObservarObj(data.data)"
								href="#"
								Target="_blank"
							>
...
export default {
	...
	data: () => ({
		namePanel: "divulgaciontransmedia",
		codEP: 585,
		duracion: [],
		popupObs: false,
		observarData: "",
	...
	created() {
		...
		root.duracion = root.subtypesByType("produccion_digital_transmedia_duracion");
		root.subtipos = root.subtypesByType("produccion_digital_categoria");
		root.tiposDocumento = root.subtypesByType("produccion_digital_documento");
