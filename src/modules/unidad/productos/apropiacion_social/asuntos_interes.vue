...
export default {
	...
	data: () => ({
		namePanel:"asuntosinteres",
        codEP: 610,//611 612 613
        popupObs: false,
        observarData:"",
	...
	created() {
		...
		root.subtipos = root.subtypesByType("asuntos_interes_categoria");
		root.tiposDocumento = root.subtypesByType("asuntos_interes_documento");
	},
	mounted() {
