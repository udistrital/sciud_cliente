					...
					<div class="card">
						...
						<div class="card-body mb-0 pb-0 pt-2">
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>Comunidad Fundadora: </label>
										<DxTextBox placeholder="Comunidad Fundadora" class="form-control" :value.sync="baseObj.funding_community">
											<DxValidator>
												<DxRequiredRule />
											</DxValidator>
										</DxTextBox>
...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("red_conocimiento_categoria");
		root.tiposDocumento = root.subtypesByType("red_conocimiento_documento");
	},
	mounted() {
