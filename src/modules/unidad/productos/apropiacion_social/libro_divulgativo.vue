...
export default {
	...
	created() {
		...
		root.subtipos = root.subtypesByType("libro_divulgacion_categoria");
		root.tiposDocumento = root.subtypesByType("libro_divulgacion_documento");
