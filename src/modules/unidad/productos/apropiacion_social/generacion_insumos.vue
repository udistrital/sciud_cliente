...
export default {
	...
	data: () => ({
		namePanel:"generacioninsumos",
        codEP: 611,//611 612 613
        popupObs: false,
        observarData:"",
	...
	created() {
		...
		root.subtipos = root.subtypesByType("generacion_insumos_categoria");
		root.tiposDocumento = root.subtypesByType("generacion_insumos_documento");
	},
	mounted() {
