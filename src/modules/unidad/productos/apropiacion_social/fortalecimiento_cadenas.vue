					...
					<div class="page-header header-elements-md-inline mb-2">
						<div class="page-title p-0 m-0">
							<h1>
								...
								<span class="font-weight-semibold">Procesos de apropiacion social del conocimiento para el fortalecimiento</span>
			...
			<div class="col">
				...
				<div class="p-0">
					...
					>
                        ...
                        <DxColumn data-field='finish_date'  caption='Fecha Fin' data-type='String' alignment='center' :visible='true' :allow-grouping='false' /> 
...
export default {
	...
	data: () => ({
		namePanel:"fortalecimientocadenas",
        codEP: 612,//611 612 613
        popupObs: false,
        observarData:"",
	...
	created() {
		...
		root.subtipos = root.subtypesByType("fortalecimiento_cadenas_categoria");
		root.tiposDocumento = root.subtypesByType("fortalecimiento_cadenas_documento");
	},
	mounted() {
