...
export default {
	...
	data: () => ({
		namePanel:"resultadotrabajo",
        codEP: 613,//611 612 613
        popupObs: false,
        observarData:"",
	...
	created() {
		...
		root.subtipos = root.subtypesByType("resultado_trabajo_categoria");
		root.tiposDocumento = root.subtypesByType("resultado_trabajo_documento");
	},
	mounted() {
