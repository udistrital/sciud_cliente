...
<div class="form-group">
 <label>Año Publicación: </label>
	<DxDateBox @focus-in="date_focus_in" @focus-out="date_focus_out" 
		class="form-control" 
				...
				<div class="p-0">
					...
					>
						...
						<template #tplObj="{ data }">
							<a
								v-if="data.data.consulting_objective != '' && data.data.consulting_objective != null"
								:title="data.data.consulting_objective"
