...
<div class="col-md-4">
	...
	<label>Titulo Revista: </label>
	<DxTextBox placeholder="Titulo Revista" class="form-control" :value.sync="baseObj.title">
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxTextBox>
...
<label>Fecha Edición: </label>
	<DxDateBox 
		class="form-control" 
		name="editorial_date" 
		:value.sync="baseObj.editorial_date" 
		id="editorial_date" 
...
<div class="col-md-3">
	<div class="form-group">
	<label>ISSN o ISBN: </label>
	<DxTextBox placeholder="ISSN o ISBN" class="form-control" :value.sync="baseObj.issn">
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxTextBox>
...
<div class="col-md-3">
	...
	<DxNumberBox placeholder="Año Publicación:" class="form-control" :value.sync="baseObj.publication_year">
	<DxValidator>
		<DxRequiredRule />
	</DxValidator>
	</DxNumberBox>
...
<div class="form-group">
 <label>Año Publicación: </label>
	<DxDateBox 
		...
		:value.sync="baseObj.publication_year" 
		id="publication_year" 
		placeholder="DD/MM/YYYY" 
		display-format="dd/MM/yyyy" 
		:min="minDate" 
			...
			<div class="col">
				...
				<div class="p-0">
					...
					>
                        ...
                        <DxColumn data-field='title'  caption='Titulo Revista' data-type='String' alignment='center' :visible='true' :allow-grouping='false' /> 
						<DxColumn data-field='editorial_date'  caption='Fecha Edición' data-type='String' alignment='center' :visible='true' :allow-grouping='true' /> 
						<DxColumn data-field='editorial_name'  caption='Editorial' data-type='String' alignment='center' :visible='true' :allow-grouping='true' /> 
						<DxColumn data-field='issn'  caption='ISSN o ISBN' data-type='String' alignment='center' :visible='true' :allow-grouping='false' /> 
						<DxColumn data-field='publication_year'  caption='Año Publicación' data-type='String' alignment='center' :visible='true' :allow-grouping='true' /> 
                        ...
                        <!-- <DxColumn data-field='consulting_objective'  caption='Objetivo' data-type='string' alignment='center' :visible='true'  cell-template="tplObj"/>  -->
                        ...
                        <template #tplObj="{ data }">
							<a v-if="data.data.consulting_objective != '' && data.data.consulting_objective != null" :title="data.data.consulting_objective" class="cmd-item color-main-600 mr-2" @click.prevent="verObservarObj(data.data)" href="#" Target="_blank">
...
export default {
	...
	data: () => ({
		namePanel:"edicionrevistas",
        codEP: null,//debo cambiar urgente 
        popupObs: false,
        observarData:"",
	...
	created() {
		...
		root.subtipos = root.subtypesByType("edicion_revista_categoria");
		root.tiposDocumento = root.subtypesByType("edicion_revista_documento");
	...
	methods: {
        ...
        verObservarObj(data){
            root.observarData=data.consulting_objective;
