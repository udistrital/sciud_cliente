					...
					<div class="card">
						...
						<div class="card-body mb-0 pb-0 pt-2">
							<div class="row">
								...
								<div class="col-md-12">
									<label>Lugar de Elaboracion: </label>
...
export default {
	...
	data: () => ({
		namePanel: "informeFinal",
		codEP: 579, //debo cambiar urgente
		popupObs: false,
		observarData: "",
	...
	created() {
		...
		root.subtipos = root.subtypesByType("informe_final_categoria");
		root.tiposDocumento = root.subtypesByType("informe_final_documento");
