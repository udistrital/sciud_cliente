...
export default {
	...
	data: () => ({
		namePanel: "divulgacionpublicacion",
		codEP: 583,
		popupObs: false,
		observarData: "",
	...
	created() {
		...
		root.subtipos = root.subtypesByType("pruducciones_editoriales_categoria");
		root.tiposDocumento = root.subtypesByType("producciones_editoriales_documento");
