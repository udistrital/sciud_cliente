					...
					<div class="card">
						...
						<div class="card-body mb-0 pb-0 pt-2">
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label>Referencia Bibliografía: </label>
										<DxTextBox placeholder="Referencia Bibliografía" class="form-control" :value.sync="baseObj.bibliographic_reference">
											<DxValidator>
												<DxRequiredRule />
											</DxValidator>
										</DxTextBox>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<DxTextBox placeholder="Nombre Revista" class="form-control" :value.sync="baseObj.magazine_name">
											<DxValidator>
												<DxRequiredRule />
											</DxValidator>
										</DxTextBox>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<DxNumberBox placeholder="Pagina Inicio" class="form-control" :value.sync="baseObj.start_page" />
										<DxValidator> </DxValidator>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<DxNumberBox placeholder="Pagina Final" class="form-control" :value.sync="baseObj.final_page" />
										<DxValidator> </DxValidator>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<DxNumberBox placeholder="Numero de Paginas" class="form-control" :value.sync="baseObj.pages_number" />
										<DxValidator> </DxValidator>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<DxDateBox
											...
											:value.sync="baseObj.generation_date"
											id="generation_date"
			...
			<div class="col">
				...
				<div class="p-0">
					...
					>
						...
						<DxColumn data-field="magazine_name" caption="Revista" data-type="String" alignment="center" :visible="true" :allow-grouping="false" />
						<DxColumn data-field="doi" caption="DOI" data-type="String" alignment="center" :visible="true" :allow-grouping="false" />
						<DxColumn data-field="generation_date" caption="Fecha" data-type="String" alignment="center" :visible="true" :allow-grouping="false" />
						<DxColumn data-field="bibliographic_reference" caption="Referencia" data-type="String" alignment="center" :visible="true" :allow-grouping="false" />
						...
						<DxColumn data-field="pages_number" caption="Numero Paginas" data-type="String" alignment="center" :visible="false" :allow-rouping="false" />
						<DxColumn data-field="start_page" caption="Pagina Inicio" data-type="String" alignment="center" :visible="false" :allow-grouping="false" />
						<DxColumn data-field="volume" caption="Volumen" data-type="String" alignment="center" :visible="false" :allow-grouping="false" />
						...
						<DxColumn data-field="product_type_name" caption="Tipo" data-type="String" alignment="center" :visible="false" :allow-grouping="false" />
						...
						<template #tplWeb="{ data }">
							<a
								v-if="data.data.web_page != '' && data.data.web_page != null"
								:title="data.data.web_page"
...
export default {
	...
	data: () => ({
		namePanel: "generacion_contenido",
		codEP: null,
		popupObs: false,
		observarData: "",
	...
	created() {
		...
		root.tipox = root.subtypesByType("generacion_contenido_tipo");
		root.subtipos = root.subtypesByType("generacion_contenido_categoria");
		root.tiposDocumento = root.subtypesByType("generacion_contenido_documento");
