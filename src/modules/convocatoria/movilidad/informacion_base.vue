        ...
        <div class="row">
            ...
            <div class='col-md-3'>
                <div class='form-group'>
                    ...
                    <p><a  :title="group.email " class="cmd-item color-main-600 mr-2" :href="'mailto:'+group.email" Target="_blank">
            ...
            <div class='col-md-3'>
                <div class='form-group'>
                    ...
                    <p><a  :title="group.gruplac" class="cmd-item color-main-600 mr-2" :href="group.gruplac" Target="_blank">
            ...
            <div class='col-md-3'>
                <div class='form-group'>
                    <label>URL: </label>
                    <p><a  :title="group.webpage " class="cmd-item color-main-600 mr-2" :href="group.webpage" Target="_blank">
                ...
                <div class="row">
                    ...
                    <div class='col-md-3'>
                        <div class='form-group'>
                            ...
                            <p class='texto'>{{ groupResearchers.datagroupmenber.researcher_is_active == true ? "Activo" :
                                    "Inactivo"
                            }}</p>
                        </div>
                    </div>
