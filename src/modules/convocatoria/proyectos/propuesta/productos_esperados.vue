              ...
              <div class="row">
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <DxTextBox
                      placeholder="Befeniciario"
                      class="form-control"
                      :value.sync="baseObj.beneficiary"
                    >
                      <DxValidator>
                        <DxRequiredRule />
                      </DxValidator>
...
export default {
  ...
  computed: {
    ...
    dataSource: function () {
      ...
      return DxStore({
        key: ["id"],
        endPoint: "proposals/" + root.propuesta.id + "/proposal_products",
  ...
  methods: {
    ...
    loadIndicators(e) {
      root.loaderShow("Lista de indicadores", "#panel-produccion .card-body");
      root.indicator2 = [];
    ...
    save() {
      ...
      if (result.isValid) {
        ...
        let dto = {
          newFormat: true,
          rute2: "proposals/" + root.propuesta.id + "/proposal_products",
          stringEP: "risks",
          mod: obj.id,
          objectSend: JSON.parse(
            `{ "proposal_product": ` + JSON.stringify(obj) + "}"
          ),
          cb: function (item) {
