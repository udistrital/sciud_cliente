					...
					<div class="page-header header-elements-md-inline mb-2">
						...
						<div class="header-elements">
							<span class="cmds mr-2">
								<button
									v-if="permisoGuardar && rubros.length > 0"
									type="button"
									@click.prevent="add()"
			...
			<div class="col">
				<div class="p-0">
					...
					>
						...
						<template #tpl="{ data }">
							<span class="cmds">
								<a title="Descripciones..." class="cmd-item color-main-600" @click.prevent="descriptions(data.data)" href="#">
				...
				<div class="row">
					<div class="col mb-2">
						<h1 class="color-text mb-0" v-if="rubro">
							Descripciones para el Rubro <span class="font-weight-semibold">"{{ rubro.item_name }}"</span>
						</h1>
					</div>
				</div>
				<div class="row">
...
export default {
	...
	methods: {
		...
		descriptions(data) {
			// console.clear();
			root.rubro = data;
			root.loaderShow(`Cargando descripciones`);
