                                ...
                                <!-- <div class="col-md-6">
									<div class="form-group">
										...
										<DxSelectBox
											...
											:value.sync="baseObj.institution"
											class="form-control"
                                ...
                                <div class="col-md-4">
									<div class="form-group">
										...
										<DxSelectBox
											...
											:search-enabled="false"
											placeholder="Seleccione..."
											:value.sync="baseObj.entity_id"
											class="form-control"
											:data-source="entidadlist2"
											display-expr="name"
											value-expr="id"
											item-template="item"
										>
											<template #item="{ data }">
												<div>{{ data.name }} - Tipo {{ data.institution_type_name }}</div>
											</template>
										</DxSelectBox>
									</div>
								</div>
                                ...
                                <div class="col-md-4">
									<div class="form-group">
										...
										<DxSelectBox
											...
											:search-enabled="false"
											placeholder="Seleccione..."
											:value.sync="baseObj.geo_country_id"
											class="form-control"
			...
			<div class="col">
				...
				<div class="p-0">
					...
					>
						...
						<DxColumn data-field="id" :width="90" caption="ID" data-type="string" alignment="center" :visible="true" :allow-grouping="false" />
						
                        <DxColumn data-field="entity_name" caption="Entidad" data-type="String" alignment="left" :visible="true" :allow-grouping="false" />
						<DxColumn data-field="institution_type_name" caption="Institución" data-type="String" alignment="left" :visible="true" :allow-grouping="false" />
                        <DxColumn data-field="geo_country_name" caption="País" data-type="String" alignment="left" :visible="true" :allow-grouping="false" /> 
                        <DxColumn data-field="active" caption="Activo" data-type="date" alignment="center" :visible="true" :customize-text="yesNo" width="70" />
                        <DxColumn :width="90" alignment="center" cell-template="tpl" caption="" />
...
<!-- 
		...
		<div class="card mt-3" v-if="debug && false">
			<div class="card-body"><b>baseObj:</b>
				{{ JSON.stringify(baseObj, null, "\t") }}
			</div>
            <!-- <div class="card-body"><b>Entidadces:</b>
				{{ JSON.stringify(entidadlist, null, "\t") }}
			</div> -->
            <div class="card-body"><b>Entidadces:</b>
				{{ JSON.stringify(entidadlist2, null, "\t") }}
			</div>
		</div>
...
export default {
	...
	created() {
		// console.clear();
		root = this;
        this.research_network_id=root.group.id;
		root.baseEnt = this.$clone(this.baseObj);
		root.getEntidad();
        root.getpaises();
        console.warn("entidades => ", root.entidadlist);
        root.entidadlist2=root.entidadlist.data;
        console.warn("entidades => data", root.entidadlist2);
		// root.tipox = root.subtypesByType("acompaniamiento_asesoria_tipo");
		root.subtipos = root.subtypesByType("redes_investigacion_tipo_estrusturas_academicas");
        
		// root.tiposDocumento = root.subtypesByType("acompaniamiento_asesoria_documento");
	...
	computed: {
        ...
        dataSource: function() {
			...
			return DxStore({
				key: ["id"],
				stringParam: data,
				endPoint: `research_networks/${root.group.id}/${root.endPointRute}`,
