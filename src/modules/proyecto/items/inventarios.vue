  ...
  <div class="col mt-3 pl-1 pr-1" id="paneltrabajosE">
    <div class="row">
      <div class="col">
        <div class="p-0">
          <div
            class="page-header header-elements-md-inline mb-2"
            v-if="!validateImp"
          >
            <div class="page-title p-0 m-0">
              <h1>
                <i class="icon-clipboard2 mr-1 color-main-600"></i>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <DxTextBox
                      placeholder="Titulo "
                      class="form-control"
                      :value.sync="baseObj.type_description"
                    >
                      <DxValidator>
                        <DxRequiredRule />
                      </DxValidator>
				...
				<div class="col-md-3">
                  <div class="form-group">
                    ...
                    <DxSwitch
                      :value.sync="baseObj.inventoried"
                      switched-on-text="SI"
                      switched-off-text="NO"
                      @value-changed="limpiadorPlaca"
                    />
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <DxTextBox
                      placeholder="Placa"
                      class="form-control"
                      :value.sync="baseObj.inventory_plate"
                      :disabled="!baseObj.inventoried"
                    >
                      <DxValidator>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <DxTextArea
                      :height="100"
                      :max-length="2500"
                      :value.sync="baseObj.description"
      ...
      <div class="col">
        <div class="p-0">
          ...
          >
            ...
            <DxColumn
              :width="100"
              data-field="classification_name"
...
export default {
  name: "seguimiento_inventarios_recursos",
  components: {
    // Commands,
    DxPopup,
    DxButton,
  ...
  created() {
    ...
    root.tipoproceso2 = root.subtypesByType(
      "Porpuesta_seguimeinto_inventario_estados"
    );
	root.tipoproceso = root.subtypesByType(
      "Proyecto_Seguimiento_Inventarios_Tipo"
    );
	// planaccion_productos_resultado_tipos
  },
  mounted() {
  ...
  computed: {
    ...
    dataSourceE: function () {
      if (typeof this.propuesta_id === "undefined") return null;
      // console.log("root.group", this.group);
      let datat = "";
      return DxStore({
        key: ["id"],
        stringParam: datat,
        // proposals/1/inventories
		endPoint: `proposals/${root.propuesta_id}/inventories`,
        onLoading: function (loadOptions) {
          root.loaderShow(
            "Cargando elementos",
            "#panel-seguimiento_inventarios .card-body"
          );
        },
  ...
  methods: {
    ...
    documentos(data) {
      ...
      $("#paneltrabajosE .item-title").html(
        `<span class="font-weight-semibold"> &raquo; Documentos</span> &raquo; ${data.row.data.type_description}`
      );
    ...
    save() {
      ...
      if (result.isValid) {
        ...
        root.baseObj.action_plan_id = root.propuesta_id;
        root.baseObj.proposal_id = root.propuesta_id;
        let obj = root.baseObj;
        let dto = {
			newFormat: true,
			rute2: "inventories", 
        //   rute: "inventories",
        //   unidadId: root.propuesta_id,
          stringEP: "inventories",
          mod: obj.id,
    ...
    active(data, state) {
      ...
      this.$confirm(msg, function (si_no) {
        ...
        if (si_no) {
          ...
          var dto = {
            newFormat: true,
            url: `proposals/${root.propuesta_id}/form_e_act_plans/${data.data.id}`,
