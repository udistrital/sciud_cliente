  ...
  <div class="mh" v-if="group">
    ...
    <div class="page-header header-elements-md-inline">
			<div class="page-title d-flex">
				<h1>
					<i class="icon-hammer-wrench mr-1 color-main-600"></i>
					<span class="font-weight-semibold">Proyecto</span> 
          <span v-if="group.id===null || typeof group.id ==='undefined'"> &raquo;Nueva Propuesta</span>
				</h1>
			</div>
<!-- 
          ...
          <div class="card-body group-detail" id="group-panel">
            ...
            <div class="row mb-3">
              <div class="col d-flex justify-content-between align-items-end">
                ...
                <div class="sub-title">
                  <i class="icon-info"></i> Información de la Propuesta &raquo;  Convocatoria Nº 2021-MOV-2021
              ...
              <DxValidationGroup ref="basicGroup">
                  ...
                  <fieldset>
                    ...
                    <div class="col-md-2">
                            ...
                            <label>Duracion Meses:</label>
                             <!-- :disabled="actInfor"    -->
                            <DxNumberBox placeholder="Meses " class="form-control" :value.sync="group.duration"  @keyDown="keyDown($event)">
                            <DxValidator> 
                                <DxRequiredRule />
                            </DxValidator> 
                            </DxNumberBox>
                ...
                <div class="col-md-12 mt-3">
                  <fieldset>
                    ...
                    <p class="parrafo-style"><i class="icon-info"></i> Si va presentarce a la convocatoria con otra estrutura de investigacion seleccionela a continuacion.</p>
                ...
                <div class="col-md-12 mt-3">
                  <fieldset>
                    ...
                    <p class="parrafo-style"><i class="icon-info"></i> Entidades previamente cargadas en el modulo de entidades,Se selecciona entidad que participan en el proyecto y esta trae las dependencias previamente relacionadas.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
...
export default {
  ...
  data: () => ({
    ...
    tipo_proyecto: [{id:1, st_name:"investigacion Básica "},{id:2, st_name:"Investigacion aplicada "},{id:3, st_name:"Desarrollo tecnológico o experimental"}],
    estado_proyecto: [{id:1, st_name:"Borrador"},{id:2, st_name:"Terminado"}],
    tipo_red: [],
    files: [],
    mode: "edit",
    group: null,
