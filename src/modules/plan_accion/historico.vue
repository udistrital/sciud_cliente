      ...
      <div class="page-title d-flex">
        <h1>
          ...
          <span class="font-weight-semibold" id="title">
            Plan de Acción e Informe de Gestión</span
          >
              ...
              <div class="col">
                <div class="col d-flex justify-content-between align-items-end">
                  <div class="title">
                    ...
                    ><small>
                      <i>Plan de Acción e Informe de Gestión</i> &raquo;
                      Histórico</small
                    >
                  </div>
                </div>
              ...
              <DxDataGrid
                ...
                <!-- <DxFilterPanel :visible="true" /> -->
                        ...
                        <DxColumn
                          ...
                          width="120"
                        >
                        <DxLookup :data-source="[{id:false, name:'Terminado...'},{id:true, name:'Editando...'}]" value-expr="id" display-expr="name" />
                        </DxColumn>
                        ...
                        <DxColumn
                          ...
                          width="120"
                        >
                        <DxLookup :data-source="[{id:true, name:'Si'},{id:false, name:'No'}]" value-expr="id" display-expr="name" />
                        </DxColumn>
                            ...
                            <span v-if="true">
                              <a
                                ...
                                @click.prevent="
                                  go(
                                    data.data.id,
                                    `/unidad/${data.data.research_group_id}/plan_accion/${data.data.id}/datos`,
                                    'Cargando Ingreso de Datos'
                                  )
                                "
                                href="#"
                              >
                              ...
                              <a
                                ...
                                @click.prevent="
                                  go(
                                    data.data.id,
                                    `/unidad/${data.data.research_group_id}/plan_accion/${data.data.id}/vista`,
                                    'Cargando Vista de Datos'
                                  )
                                "
                                href="#"
                              >
        ...
        <div class="col">
          <p>
            ...
            <span class="font-weight-semibold">
              Seleccione el año de vigencia para crear el plan de acción y
              presione el botón guardar.</span
            >
          </p>
...
export default {
  created: function () {
    root = this;
    root.rutaprincipal =
      String(location.href).slice(0, -this.$route.path.length) + "/unidad";
  ...
  methods: {
    ...
    nuevo() {
      let msg =
        "¿Está seguro que desea crear un nuevo plan de acción?<br>Nota: Recuerde que este no podrá ser eliminado o editado.";
    ...
    activeInfo(data, state) {
      ...
      if (data.data.is_draft == false) {
        ...
        root.$info(
          "Debe terminar el plan de acción para continuar con esta tarea."
        );
      }
    },
    ...
    activePlan(data, state) {
      ...
      this.$confirm(msg, function (si_no) {
        ...
        if (si_no) {
          ...
          if (data.data.execution_validity == 0)
            root.baseObj.execution_validity = 2021;
