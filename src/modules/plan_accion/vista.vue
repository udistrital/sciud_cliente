  ...
  <div>
    <div class="page-header header-elements-md-inline" id="panel-unidades-head">
      ...
      <div class="header-elements" v-if="true">
        <router-link
          tag="a"
          :to="'/unidad/' + $route.params.unidadId + '/plan_accion'"
                ...
                <table width="100%" border="0">
                  <thead>
                    <tr>
                      ...
                      <th>
                        <center>
                          PLAN DE ACCIÓN ANUAL DE GRUPO Y/O SEMILLERO DE
                          <br />INVESTIGACIÓN-CREACIÓN E iNNOVACIÓN
                        </center>
                      </th>
                      <th rowspan="3">
                        <center>
                          <img
                            :src="imgUrl + '/sigud.png'"
                            alt="UDis"
                            width="150"
                          />
                        </center>
            ...
            <div class="row">
              <div class="col-md-12 mt-3">
                <fieldset>
                  <legend>
                    <small
                      >Proceso de Formación para la Investigación/Investigación
                      Formativa
                    </small>
                  </legend>
                  <ProcesoFormacion
            ...
            <div class="row">
              <div class="col-md-12 mt-3">
                <fieldset>
                  <legend>
                    <small
                      >Productos Resultado de Procesos de Investigación Creacion
                      e Innovación a Generar para el Periodo Anual
                    </small>
                  </legend>
                  <ProductosResultados
                    :group="group"
            ...
            <div class="row">
              <div class="col-md-12 mt-3">
                <fieldset>
                  <legend>
                    <small
                      >Productos Con Potencialidad de Transferencia a prestar a
                      la OTRI-Bogotá en el Periodo Anual
                    </small>
                  </legend>
...
export default {
  ...
  components: {
    VueHtml2pdf,
    ProcesoFormacion: () =>
      import("@/modules/plan_accion/forms/proceso_formacion"),
    ProductosTransferencia: () =>
      import("@/modules/plan_accion/forms/productos_transferencia"),
    RedesAcademicas: () =>
      import("@/modules/plan_accion/forms/redes_academicas"),
    ProyectoInvestigacion: () =>
      import("@/modules/plan_accion/forms/proyecto_investigacion"),
    ProductosResultados: () =>
      import("@/modules/plan_accion/forms/productos_resultado"),
